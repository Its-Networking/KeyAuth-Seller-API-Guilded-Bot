...
{
    internal class EditChannel
    {
        public static void Chats_EditChannel(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "EditChannel"))
