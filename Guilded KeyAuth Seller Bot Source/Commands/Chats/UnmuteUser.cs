...
{
    internal class UnmuteUser
    {
        public static void Chats_UnmuteUser(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "UnmuteUser"))
