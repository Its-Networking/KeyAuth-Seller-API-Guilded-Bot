...
{
    internal class DeleteVar
    {
        public static void Var_DeleteVar(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "DeleteVar"))
