...
{
    internal class UnbanUser
    {
        public static void Users_UnbanUser(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "UnbanUser"))
