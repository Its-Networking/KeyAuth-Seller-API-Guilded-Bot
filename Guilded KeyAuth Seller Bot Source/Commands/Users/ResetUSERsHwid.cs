...
{
    internal class ResetUSERsHwid
    {
        public static void Users_ResetUserHWID(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "ResetUserHWID"))
