...
{
    internal class AddNewWhitelists
    {
        public static void Whitelist_AddWhitelist(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "AddWhitelist"))
