...
{
    internal class SetNote
    {
        public static void License_SetNote(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "SetNote"))
