...
{
    internal class UnbanLicense
    {
        public static void License_UnBanLicense(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "UnbanLicense"))
