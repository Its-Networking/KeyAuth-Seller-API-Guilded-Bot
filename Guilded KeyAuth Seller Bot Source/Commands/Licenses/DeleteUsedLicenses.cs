...
{
    internal class DeleteUsedLicenses
    {
        public static void License_DeleteUsedLicenses(GuildedBotClient client, string prefix)
        {
            client.MessageCreated
                .Where(msgCreated => msgCreated.Content.StartsWith(prefix + "DeleteUsedLicenses"))
